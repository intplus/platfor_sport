...
<%--<nav class="page-navigation">--%>
    <%--<div class="container">--%>
        <%--<ul>--%>
            ...
            <%--&lt;%&ndash;<li><a href="#">Просмотр моей страници</a></li>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<li><a href="#">Статистика</a></li>&ndash;%&gt;--%>
            <%--&lt;%&ndash;<li><a href="#">Расчеты</a></li>&ndash;%&gt;--%>
        <%--</ul>--%>
...
<%--background: #cccccc; "  >--%>
        ...
        <%--<input type="button" value="Отправить смс">--%>
            <%--&lt;%&ndash;<input type="button" value="отправить письмо">&ndash;%&gt;--%>
    <%--</div>--%>
<%--</div>--%>
<%--<br/><br/>--%>
<%--<br/><br/>--%>
